...
export default function SettingsPage() {
  ...
  const exportPdf = async () => {
    try {
      ...
      <div class="hdr"><div><h1>Family Investment Report</h1><div class="dm">Assets View</div></div><div class="dm">${new Date().toLocaleString('en-IN')}</div></div>
      ...
      <div class="ft">Assets View Family Finance</div>
